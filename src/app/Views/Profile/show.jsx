...
const ProfileShow = props => {
    ...
    const empty = { info: {}, physical: {}, technical: {}, attender: {}, insurance: {}, observation: {} }
    ...
    const { info, physical, technical, attender, insurance, observation } = profile

    useEffect(() => {
        handlerGetProfile({ id, setProfile, setLoading })
    }, [])
